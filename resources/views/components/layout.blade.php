    ...
    <div class="min-h-full">
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6 space-x-4">
                            @guest
                                <a href="/login" class="rounded-lg bg-gray-500 pt-2 pb-2 pr-2 pl-2 text-white">Login</a>
                                <a href="/register"
                                    class="rounded-lg bg-gray-500 pt-2 pb-2 pr-2 pl-2 text-white">Register</a>
                            @endguest
                            @auth
                            <form action="/logout" method="post" class=" inline">
                                @csrf
                                <button type="submit" class="rounded-lg bg-gray-500 pt-2 pb-2 pr-2 pl-2 text-white">Logout</button>
                            </form>
                            @endauth
                        </div>
                    </div>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                ...
                <a href="/jobs/create" class="rounded-lg bg-gray-500 text-white p-2">Create Job</a>
            </div>
        </header>
        <main>
